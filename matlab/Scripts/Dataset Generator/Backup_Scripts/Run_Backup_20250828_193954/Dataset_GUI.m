...
for batch_idx = start_batch:num_batches
    ...
    try
        ...
        attached_files = {
            config.model_path, ...
            fullfile(functions_path, 'runSingleTrial.m'), ...
            fullfile(functions_path, 'processSimulationOutput.m'), ...
            fullfile(functions_path, 'setModelParameters.m'), ...
            fullfile(functions_path, 'setPolynomialCoefficients.m'), ...
            fullfile(functions_path, 'extractSignalsFromSimOut.m'), ...
            fullfile(functions_path, 'extractFromCombinedSignalBus.m'), ...
            fullfile(functions_path, 'extractFromNestedStruct.m'), ...
            fullfile(functions_path, 'extractLogsoutDataFixed.m'), ...
            fullfile(functions_path, 'extractSimscapeDataRecursive.m'), ...
            fullfile(functions_path, 'traverseSimlogNode.m'), ...
            fullfile(functions_path, 'extractDataFromField.m'), ...
            fullfile(functions_path, 'combineDataSources.m'), ...
            fullfile(functions_path, 'addModelWorkspaceData.m'), ...
            fullfile(functions_path, 'extractWorkspaceOutputs.m'), ...
            fullfile(functions_path, 'resampleDataToFrequency.m'), ...
            fullfile(functions_path, 'getPolynomialParameterInfo.m'), ...
            fullfile(functions_path, 'getShortenedJointName.m'), ...
            fullfile(functions_path, 'generateRandomCoefficients.m'), ...
            fullfile(functions_path, 'prepareSimulationInputsForBatch.m'), ...
            fullfile(functions_path, 'restoreWorkspace.m'), ...
            fullfile(functions_path, 'loadInputFile.m'), ...
            fullfile(functions_path, 'checkStopRequest.m'), ...
            fullfile(functions_path, 'shouldShowDebug.m'), ...
            fullfile(functions_path, 'shouldShowVerbose.m'), ...
            fullfile(functions_path, 'shouldShowNormal.m'), ...
            fullfile(functions_path, 'mergeTables.m'), ...
            fullfile(functions_path, 'fallbackSimlogExtraction.m'), ...
            fullfile(functions_path, 'extractTimeSeriesData.m'), ...
            fullfile(functions_path, 'extractConstantMatrixData.m')
            };
...
% extractSignalsFromSimOut function moved to functions folder for enhanced functionality

% addModelWorkspaceData function moved to functions folder for enhanced functionality
