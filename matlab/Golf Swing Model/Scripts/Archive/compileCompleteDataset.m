...
cleanup_vars = {'all_data', 'simulation_id', 'sim_idx', 'polynomial_coeffs', ...
                'simInput', 'simOut', 'sim_data', 'data_table', 'column_names', ...
                'config', 'timestamp', 'ME', 'i', 'j', 'field_name', 'coeff_values', ...
                'time_vector', 'target_time', 'num_time_points', 'logsout', ...
                'element', 'signal_name', 'data', 'time', 'resampled_data', ...
                'expected_structs', 'struct_name', 'log_struct', 'fields', ...
                'field_data', 'simlog', 'child_nodes', 'child_node', 'node_name', ...
                'signals', 'signal', 'rotation_fields', 'matrix_data', 'n_frames', ...
                'flattened', 'n_rows', 'n_cols', 'col', 'joints', 'joint', ...
