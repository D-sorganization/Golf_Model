...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('golf_visualizer.log'),
...
try:
    ...
    from golf_camera_system import CameraController, CameraPreset, CameraMode
except ImportError as e:
    logger.error(f"Failed to import core modules: {e}")
    print("❌ Core modules not found. Please ensure all files are in the same directory.")
    print(f"Error: {e}")
    sys.exit(1)
...
class EnhancedGolfVisualizerApp(QApplication):
    ...
    def _create_splash_screen(self) -> QSplashScreen:
        ...
        splash.setFont(font)
        splash.showMessage("Golf Swing Visualizer Pro\nLoading...", 
...
class EnhancedMainWindow(GolfVisualizerMainWindow):
    ...
    def _setup_enhanced_shortcuts(self):
        ...
        QShortcut(QKeySequence("Shift+Left"), self).activated.connect(lambda: self._jump_frames(-100))
        QShortcut(QKeySequence("Shift+Right"), self).activated.connect(lambda: self._jump_frames(100))
        ...
        try:
            ...
            if success:
                ...
                if self.gl_widget.frame_processor:
                    sample_frames = [0, self.gl_widget.num_frames // 4, 
                    ...
                    for frame_idx in sample_frames:
                        ...
                        data_points.extend([
                            frame_data.butt, frame_data.clubhead, frame_data.midpoint,
                            frame_data.left_shoulder, frame_data.right_shoulder
                        ])
    ...
    def _show_export_dialog(self):
        ...
        start_spin = QSpinBox()
        start_spin.setMaximum(self.gl_widget.num_frames - 1 if self.gl_widget.frame_processor else 0)
