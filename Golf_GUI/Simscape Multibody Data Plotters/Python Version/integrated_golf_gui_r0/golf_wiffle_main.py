...
from PyQt6.QtGui import QAction, QMouseEvent, QWheelEvent, QKeyEvent, QSurfaceFormat, QFont
...
class WiffleGolfMainWindow(QMainWindow):
    ...
    def _create_control_panels(self):
        ...
        data_dock.setAllowedAreas(Qt.DockWidgetArea.LeftDockWidgetArea | Qt.DockWidgetArea.RightDockWidgetArea)
        ...
        wiffle_dock.setAllowedAreas(Qt.DockWidgetArea.LeftDockWidgetArea | Qt.DockWidgetArea.RightDockWidgetArea)
        ...
        analysis_dock.setAllowedAreas(Qt.DockWidgetArea.LeftDockWidgetArea | Qt.DockWidgetArea.RightDockWidgetArea)
    ...
    def _load_excel_file(self, file_path: str = None):
        ...
        if file_path is None:
            file_path, _ = QFileDialog.getOpenFileName(
                self, "Load Wiffle_ProV1 Excel File", 
    ...
    def _calculate_metrics(self):
        ...
        try:
            ...
            metrics_text += f"  Difference: {abs(prov1_max_speed - wiffle_max_speed):.2f} m/s\n\n"
    ...
    def _update_frame_metrics(self, frame_idx: int):
        ...
        try:
            ...
            self.statusBar().showMessage(f"Frame {frame_idx+1}, Time: {time_val:.3f}s, Distance: {distance:.3f}m")
    ...
    def _show_about(self):
        """Show about dialog"""
        QMessageBox.about(
            self, "About Golf Swing Visualizer",
