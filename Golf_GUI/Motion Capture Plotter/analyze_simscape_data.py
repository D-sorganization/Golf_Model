...
def analyze_simscape_data(csv_file):
    ...
    # Hand positions
    hand_positions = [col for col in position_columns if any(x in col for x in ['LHGlobalPosition', 'RHGlobalPosition'])]
    if hand_positions:
    ...
    # Wrist positions
    wrist_positions = [col for col in position_columns if any(x in col for x in ['LWLogs', 'RWLogs'])]
    if wrist_positions:
    ...
    # Elbow positions
    elbow_positions = [col for col in position_columns if any(x in col for x in ['LELogs', 'RELogs'])]
    if elbow_positions:
    ...
    # Shoulder positions
    shoulder_positions = [col for col in position_columns if any(x in col for x in ['LSLogs', 'RSLogs'])]
    ...
    # Scapula positions
    scapula_positions = [col for col in position_columns if any(x in col for x in ['LScapLogs', 'RScapLogs'])]
    ...
    segments = {
        'midpoint_to_clubhead': ['MidpointCalcsLogs_MPGlobalPosition_1', 'MidpointCalcsLogs_MPGlobalPosition_2', 'MidpointCalcsLogs_MPGlobalPosition_3', 
                                'ClubLogs_CHGlobalPosition_1', 'ClubLogs_CHGlobalPosition_2', 'ClubLogs_CHGlobalPosition_3'],
        'left_hand_to_midpoint': ['LHCalcsLogs_LeftHandPostion_1', 'LHCalcsLogs_LeftHandPostion_2', 'LHCalcsLogs_LeftHandPostion_3',
                                 'MidpointCalcsLogs_MPGlobalPosition_1', 'MidpointCalcsLogs_MPGlobalPosition_2', 'MidpointCalcsLogs_MPGlobalPosition_3'],
        'right_hand_to_midpoint': ['RHCalcsLogs_RightHandPostion_1', 'RHCalcsLogs_RightHandPostion_2', 'RHCalcsLogs_RightHandPostion_3',
                                  'MidpointCalcsLogs_MPGlobalPosition_1', 'MidpointCalcsLogs_MPGlobalPosition_2', 'MidpointCalcsLogs_MPGlobalPosition_3'],
        'left_hand_to_left_elbow': ['LHCalcsLogs_LeftHandPostion_1', 'LHCalcsLogs_LeftHandPostion_2', 'LHCalcsLogs_LeftHandPostion_3',
                                   'LELogs_LArmonLForearmFGlobal_1', 'LELogs_LArmonLForearmFGlobal_2', 'LELogs_LArmonLForearmFGlobal_3'],
        'right_hand_to_right_elbow': ['RHCalcsLogs_RightHandPostion_1', 'RHCalcsLogs_RightHandPostion_2', 'RHCalcsLogs_RightHandPostion_3',
                                     'RELogs_RArmonLForearmFGlobal_1', 'RELogs_RArmonLForearmFGlobal_2', 'RELogs_RArmonLForearmFGlobal_3'],
        'left_elbow_to_left_shoulder': ['LELogs_LArmonLForearmFGlobal_1', 'LELogs_LArmonLForearmFGlobal_2', 'LELogs_LArmonLForearmFGlobal_3',
                                       'LSLogs_GlobalPosition_1', 'LSLogs_GlobalPosition_2', 'LSLogs_GlobalPosition_3'],
        'right_elbow_to_right_shoulder': ['RELogs_RArmonLForearmFGlobal_1', 'RELogs_RArmonLForearmFGlobal_2', 'RELogs_RArmonLForearmFGlobal_3',
                                         'RSLogs_GlobalPosition_1', 'RSLogs_GlobalPosition_2', 'RSLogs_GlobalPosition_3'],
        'left_shoulder_to_hub': ['LSLogs_GlobalPosition_1', 'LSLogs_GlobalPosition_2', 'LSLogs_GlobalPosition_3',
                                'HipLogs_HUBGlobalPosition_1', 'HipLogs_HUBGlobalPosition_2', 'HipLogs_HUBGlobalPosition_3'],
        'right_shoulder_to_hub': ['RSLogs_GlobalPosition_1', 'RSLogs_GlobalPosition_2', 'RSLogs_GlobalPosition_3',
                                 'HipLogs_HUBGlobalPosition_1', 'HipLogs_HUBGlobalPosition_2', 'HipLogs_HUBGlobalPosition_3'],
        'hub_to_spine': ['HipLogs_HUBGlobalPosition_1', 'HipLogs_HUBGlobalPosition_2', 'HipLogs_HUBGlobalPosition_3',
                        'SpineLogs_GlobalPosition_1', 'SpineLogs_GlobalPosition_2', 'SpineLogs_GlobalPosition_3'],
        'spine_to_hips': ['SpineLogs_GlobalPosition_1', 'SpineLogs_GlobalPosition_2', 'SpineLogs_GlobalPosition_3',
                         'HipLogs_HipGlobalPosition_dim1', 'HipLogs_HipGlobalPosition_dim2', 'HipLogs_HipGlobalPosition_dim3']
    }
