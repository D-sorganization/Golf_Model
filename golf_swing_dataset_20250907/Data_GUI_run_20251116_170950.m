...
% CRITICAL: Add functions folder to MATLAB path for parallel processing
% Parallel workers need access to external functions in this folder
script_dir = fileparts(mfilename('fullpath'));
functions_dir = fullfile(script_dir, 'functions');
if ~contains(path, functions_dir)
