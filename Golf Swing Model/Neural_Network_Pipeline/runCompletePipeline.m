...
if trainNewModel
    ...
    datasetPath = 'Data/training_data.mat';
...
if runControlDemo
    ...
    modelPath = 'Models/inverse_dynamics_model.mat';
...
function checkOutputFiles()
    ...
    % Dataset files
    datasetFiles = {
        'Data/training_data.mat',
        'Data/golf_swing_dataset.mat',
        'Data/dataset_metadata.mat'
    };
    ...
    % Model files
    modelFiles = {
        'Models/inverse_dynamics_model.mat',
        'Models/predictions.mat'
    };
