...
function handles = createMainLayout(fig, handles)
    ...
    handles.start_button = uicontrol('Parent', titlePanel, ...
                                    ...
                                    'String', 'Start', ...
                                    'Units', 'normalized', ...
                                    'Position', [0.45, buttonY, buttonWidth, buttonHeight], ...
    ...
    handles.stop_button = uicontrol('Parent', titlePanel, ...
                                   ...
                                   'String', 'Stop', ...
                                   'Units', 'normalized', ...
                                   'Position', [0.45 + buttonWidth + buttonSpacing, buttonY, buttonWidth, buttonHeight], ...
    ...
    handles.save_config_button = uicontrol('Parent', titlePanel, ...
                                          ...
                                          'String', 'Save Config', ...
                                          'Units', 'normalized', ...
                                          'Position', [0.45 + 2*(buttonWidth + buttonSpacing), buttonY, buttonWidth + 0.02, buttonHeight], ...
    ...
    handles.load_config_button = uicontrol('Parent', titlePanel, ...
                                          ...
                                          'String', 'Load Config', ...
                                          'Units', 'normalized', ...
                                          'Position', [0.45 + 3*(buttonWidth + buttonSpacing) + 0.02, buttonY, buttonWidth + 0.02, buttonHeight], ...
                                          'BackgroundColor', colors.secondary, ...
                                          'ForegroundColor', 'white', ...
                                          'FontWeight', 'bold', ...
...
function handles = createLeftColumnContent(parent, handles)
    ...
    h1 = 1.0 * availableHeight;  % Configuration panel takes full height
...
function handles = createRightColumnContent(parent, handles)
    ...
    h1 = 0.30 * availableHeight;  % Increased summary section height
    h2 = 0.25 * availableHeight;
    h3 = 0.30 * availableHeight;  % Increased coefficients panel height
    h4 = 0.15 * availableHeight;  % Reduced batch settings
...
function handles = createTrialAndDataPanel(parent, handles, yPos, height)
    ...
    % Layout
    rowHeight = 0.035;  % Even smaller to match dropdown size exactly
    labelWidth = 0.22;
    fieldSpacing = 0.02;
    y = 0.95;  % Start higher to fit more content
    ...
    handles.enable_performance_monitoring = uicontrol('Parent', panel, ...
                                                     ...
                                                     'Value', 1, ...
                                                     'Units', 'normalized', ...
                                                     'Position', [0.40, y, 0.30, rowHeight], ...
                                                     'BackgroundColor', colors.panel, ...
                                                     'ForegroundColor', colors.text, ...
                                                     'FontSize', 9, ...
    ...
    uicontrol('Parent', panel, ...
              ...
              'Units', 'normalized', ...
              'Position', [0.02, y, 0.20, rowHeight], ...
              'HorizontalAlignment', 'left', ...
              'BackgroundColor', colors.panel);
    ...
    handles.coeff_range_edit = uicontrol('Parent', panel, ...
                                        ...
                                        'String', '50', ...
                                        'Units', 'normalized', ...
                                        'Position', [0.23, y, 0.15, rowHeight], ...
                                        'BackgroundColor', 'white', ...
                                        'HorizontalAlignment', 'center', ...
                                        'Callback', @updateCoefficientsPreview);
    ...
    uicontrol('Parent', panel, ...
              ...
              'Units', 'normalized', ...
              'Position', [0.45, y, 0.20, rowHeight], ...
              'HorizontalAlignment', 'left', ...
              'BackgroundColor', colors.panel);
    ...
    handles.constant_value_edit = uicontrol('Parent', panel, ...
                                           ...
                                           'String', '10', ...
                                           'Units', 'normalized', ...
                                           'Position', [0.66, y, 0.15, rowHeight], ...
                                           'BackgroundColor', 'white', ...
                                           'HorizontalAlignment', 'center', ...
                                           'Enable', 'off', ...
                                           'Callback', @updateCoefficientsPreview);
    ...
    handles.progress_text = uicontrol('Parent', panel, ...
                                     ...
                                     'Units', 'normalized', ...
                                     'Position', [0.18, y, 0.80, rowHeight], ...
                                     'FontWeight', 'normal', ...
                                     'FontSize', 9, ...
                                     'HorizontalAlignment', 'left', ...
                                     'BackgroundColor', colors.panel, ...
