...
function handles = createRightColumnContent(parent, handles)
    ...
    h1 = 0.20 * availableHeight;  % Reduced summary section height
    h2 = 0.30 * availableHeight;  % Increased joint editor height
    h3 = 0.35 * availableHeight;  % Reduced coefficients panel height slightly
