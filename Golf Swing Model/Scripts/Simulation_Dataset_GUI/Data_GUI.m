...
function handles = createLeftColumnContent(parent, handles)
    ...
    % Calculate heights
    numPanels = 3;  % Configuration, Modeling, Progress
    totalSpacing = panelPadding + (numPanels-1)*panelSpacing + panelPadding;
    availableHeight = 1 - totalSpacing;
    
    h1 = 0.70 * availableHeight;  % Configuration panel (increased significantly)
    h2 = 0.15 * availableHeight;  % Modeling panel
    h3 = 0.15 * availableHeight;  % Progress panel
...
function handles = createRightColumnContent(parent, handles)
    ...
    h1 = 0.26 * availableHeight;  % Reduced from 0.35 to 3/4 of current height
    h2 = 0.25 * availableHeight;
    h3 = 0.25 * availableHeight;  % Increased coefficients panel height
    h4 = 0.24 * availableHeight;  % Increased to use the freed space
...
function handles = createTrialAndDataPanel(parent, handles, yPos, height)
    ...
    % Layout
    rowHeight = 0.06;  % Further reduced to fit more content
    labelWidth = 0.22;
    fieldSpacing = 0.02;
    y = 0.92;  % Start higher to fit more content
