...
function handles = createRightColumnContent(parent, handles)
    ...
    h1 = 0.35 * availableHeight;  % Increased summary section height by 1.75x (0.20 * 1.75 = 0.35)
    h2 = 0.20 * availableHeight;  % Reduced joint editor height to make room
    h3 = 0.30 * availableHeight;  % Increased coefficients panel height by 1.25x (0.24 * 1.25 = 0.30)
...
function handles = createTrialAndDataPanel(parent, handles, yPos, height)
    ...
    handles.use_logsout = uicontrol('Parent', panel, ...
                                   ...
                                   'Units', 'normalized', ...
                                   'Position', [textBoxStart + 0.16, y, 0.30, rowHeight], ...
                                   'Value', 1, ...
                                   'BackgroundColor', colors.panel);
    ...
    handles.enable_performance_monitoring = uicontrol('Parent', panel, ...
                                                     ...
                                                     'Value', 1, ...
                                                     'Units', 'normalized', ...
                                                     'Position', [textBoxStart + 0.32, y, 0.30, rowHeight], ...
                                                     'BackgroundColor', colors.panel, ...
                                                     'ForegroundColor', colors.text, ...
                                                     'FontSize', 9, ...
