...
function handles = createBatchSettingsPanel(parent, handles, yPos, height)
    ...
    uicontrol('Parent', panel, ...
              ...
              'FontSize', 8, ...
              'FontWeight', 'bold', ...
              'Callback', @(src, event) showBatchSettingHelp('Batch Size', 'Number of simulations to process in each batch. Smaller batches use less memory but may be slower. Recommended: 25-100 for most systems.'));
    
    uicontrol('Parent', panel, ...
              'Style', 'text', ...
              'String', 'trials', ...
              'Units', 'normalized', ...
              'Position', [0.40, y, 0.08, rowHeight], ...
              'HorizontalAlignment', 'left', ...
              'BackgroundColor', colors.panel, ...
              'FontSize', 9);
    ...
    uicontrol('Parent', panel, ...
              ...
              'FontSize', 8, ...
              'FontWeight', 'bold', ...
              'Callback', @(src, event) showBatchSettingHelp('Save Interval', 'Save checkpoint every N batches. More frequent saves protect against crashes but may slow down processing. Recommended: 10-50 batches.'));
    
    uicontrol('Parent', panel, ...
              'Style', 'text', ...
              'String', 'batches', ...
              'Units', 'normalized', ...
              'Position', [0.80, y, 0.08, rowHeight], ...
              'HorizontalAlignment', 'left', ...
              'BackgroundColor', colors.panel, ...
              'FontSize', 9);
    ...
    handles.enable_performance_monitoring = uicontrol('Parent', panel, ...
                                                     ...
                                                     'Value', 1, ...
                                                     'Units', 'normalized', ...
                                                     'Position', [0.02, y, 0.40, rowHeight], ...
                                                     'BackgroundColor', colors.panel, ...
                                                     'ForegroundColor', colors.text, ...
                                                     'FontSize', 9, ...
                                                     'TooltipString', 'Track execution times, memory usage, and performance metrics');
    
    % Help button for Performance Monitoring
    uicontrol('Parent', panel, ...
              'Style', 'pushbutton', ...
              'String', '?', ...
              'Units', 'normalized', ...
              'Position', [0.43, y, 0.08, rowHeight], ...
              'BackgroundColor', [0.8, 0.8, 1], ...
              'ForegroundColor', 'black', ...
              'FontSize', 8, ...
              'FontWeight', 'bold', ...
              'Callback', @(src, event) showBatchSettingHelp('Performance Monitoring', 'Track execution times, memory usage, and performance metrics. Provides detailed analysis of bottlenecks and optimization opportunities.'));
    ...
    uicontrol('Parent', panel, ...
              ...
              'String', 'Verbosity:', ...
              'Units', 'normalized', ...
              'Position', [0.52, y, 0.12, rowHeight], ...
              'HorizontalAlignment', 'left', ...
              'BackgroundColor', colors.panel);
    ...
    handles.verbosity_popup = uicontrol('Parent', panel, ...
                                       ...
                                       'Value', 1, ...
                                       'Units', 'normalized', ...
                                       'Position', [0.65, y, 0.30, rowHeight], ...
                                       'BackgroundColor', 'white', ...
                                       'FontSize', 9, ...
                                       'TooltipString', 'Output detail level: Silent=minimal, Normal=standard, Verbose=detailed, Debug=all');
    
    % Help button for Verbosity
    uicontrol('Parent', panel, ...
              'Style', 'pushbutton', ...
              'String', '?', ...
              'Units', 'normalized', ...
              'Position', [0.96, y, 0.08, rowHeight], ...
              'BackgroundColor', [0.8, 0.8, 1], ...
              'ForegroundColor', 'black', ...
              'FontSize', 8, ...
              'FontWeight', 'bold', ...
              'Callback', @(src, event) showBatchSettingHelp('Verbosity', 'Output detail level: Silent=minimal output, Normal=standard progress, Verbose=detailed info, Debug=all messages including technical details.'));
    ...
    % Help button for Robust Generator
    uicontrol('Parent', panel, ...
              'Style', 'pushbutton', ...
              'String', '?', ...
              'Units', 'normalized', ...
              ...
              'FontSize', 8, ...
              'FontWeight', 'bold', ...
              'Callback', @(src, event) showBatchSettingHelp('Robust Generator', 'Enable crash-resistant batch processing with memory monitoring and checkpointing. Automatically recovers from crashes and manages system resources.'));
    ...
    handles.enable_memory_monitoring = uicontrol('Parent', panel, ...
                                                ...
                                                'Value', 1, ...
                                                'Units', 'normalized', ...
                                                'Position', [0.52, y, 0.40, rowHeight], ...
                                                'BackgroundColor', colors.panel, ...
                                                'ForegroundColor', colors.text, ...
                                                'FontSize', 9, ...
                                                'TooltipString', 'Monitor system memory and automatically manage parallel workers');
    
    % Help button for Memory Monitoring
    uicontrol('Parent', panel, ...
              'Style', 'pushbutton', ...
              'String', '?', ...
              'Units', 'normalized', ...
              'Position', [0.93, y, 0.08, rowHeight], ...
              'BackgroundColor', [0.8, 0.8, 1], ...
              'ForegroundColor', 'black', ...
              'FontSize', 8, ...
              'FontWeight', 'bold', ...
              'Callback', @(src, event) showBatchSettingHelp('Memory Monitoring', 'Monitor system memory and automatically manage parallel workers. Helps prevent crashes due to memory exhaustion.'));
end
...
function showBatchSettingHelp(setting_name, help_text)
    % Create a simple help dialog for batch settings
    help_dialog = figure('Name', sprintf('Help: %s', setting_name), ...
                        'NumberTitle', 'off', ...
                        'MenuBar', 'none', ...
                        'ToolBar', 'none', ...
                        'Resize', 'off', ...
