...
function handles = createExportSettingsContent(parent, handles)
    % Create export settings interface - completely redesigned left column
    colors = handles.colors;
