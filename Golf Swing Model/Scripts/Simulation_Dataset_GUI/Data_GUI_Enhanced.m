...
function handles = createProcessingOptionsContent(parent, handles)
    ...
    uicontrol('Parent', parent, ...
              'Style', 'text', ...
              'String', 'Work Calculation Options:', ...
              'Units', 'normalized', ...
    ...
    handles.calculate_work_checkbox = uicontrol('Parent', parent, ...
                                               'Style', 'checkbox', ...
                                               'String', 'Calculate work values (disable for random inputs)', ...
                                               'Units', 'normalized', ...
    ...
    handles.include_applied_torques_checkbox = uicontrol('Parent', parent, ...
                                                        'Style', 'checkbox', ...
                                                        'String', 'Include applied torques in angular impulse', ...
                                                        'Units', 'normalized', ...
                                                        'Position', [0.05, 0.25, 0.9, 0.04], ...
                                                        'BackgroundColor', colors.panel, ...
                                                        'Value', 1);
    
    handles.include_force_moments_checkbox = uicontrol('Parent', parent, ...
                                                      'Style', 'checkbox', ...
                                                      'String', 'Include force moments in angular impulse', ...
                                                      'Units', 'normalized', ...
                                                      'Position', [0.05, 0.2, 0.9, 0.04], ...
                                                      'BackgroundColor', colors.panel, ...
                                                      'Value', 1);
...
function startPostProcessing(~, ~)
    ...
    % Get work calculation options
    calculate_work = get(handles.calculate_work_checkbox, 'Value');
    include_applied_torques = get(handles.include_applied_torques_checkbox, 'Value');
    include_force_moments = get(handles.include_force_moments_checkbox, 'Value');
    ...
    processing_data.include_applied_torques = include_applied_torques;
    processing_data.include_force_moments = include_force_moments;
...
function processed_trial = processTrialData(data, processing_data)
    ...
    processed_trial.calculation_options.include_applied_torques = processing_data.include_applied_torques;
    processed_trial.calculation_options.include_force_moments = processing_data.include_force_moments;
    ...
    if isfield(data, 'ZTCFQ') && isfield(data, 'DELTAQ')
        try
            ...
            options.include_applied_torques = processing_data.include_applied_torques;
            options.include_force_moments = processing_data.include_force_moments;
            
            % Apply enhanced calculations
            [processed_trial.ZTCFQ_enhanced, processed_trial.DELTAQ_enhanced] = ...
                calculateWorkPowerAndAngularImpulse3D(data.ZTCFQ, data.DELTAQ, options);
            
            fprintf('Enhanced calculations applied to trial data.\n');
        catch ME
