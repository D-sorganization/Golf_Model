...
function handles = createPostProcessingTabContent(parent, handles)
    ...
    % Create file selection content (moved to middle panel)
    handles = createFileSelectionContent(middlePanel, handles);
    
    % Create export settings content (new left panel)
    handles = createExportSettingsContent(leftPanel, handles);
    
    % Create calculation options content (expanded middle panel)
...
function handles = createCalculationOptionsContent(parent, handles)
    % Create calculation options interface with detailed checkboxes
    colors = handles.colors;
    
    % Calculation description
    uicontrol('Parent', parent, ...
              'Style', 'text', ...
              'String', 'Additional Calculations Available:', ...
              'Units', 'normalized', ...
              'Position', [0.05, 0.6, 0.9, 0.04], ...
              'FontWeight', 'bold', ...
              'HorizontalAlignment', 'left', ...
              'BackgroundColor', colors.panel);
    ...
    uicontrol('Parent', parent, ...
              'Style', 'text', ...
              'String', 'Select which calculations to perform. Each calculation is independent and can be enabled/disabled separately.', ...
              'Units', 'normalized', ...
              'Position', [0.05, 0.56, 0.9, 0.04], ...
              'FontWeight', 'normal', ...
              'HorizontalAlignment', 'left', ...
              'BackgroundColor', colors.panel, ...
              'ForegroundColor', colors.textLight, ...
    ...
    uicontrol('Parent', parent, ...
              'Style', 'text', ...
              'String', 'Work & Power Calculations:', ...
              'Units', 'normalized', ...
              'Position', [0.05, 0.51, 0.9, 0.04], ...
              'FontWeight', 'bold', ...
              'HorizontalAlignment', 'left', ...
              'BackgroundColor', colors.panel);
    ...
    handles.calculate_work_checkbox = uicontrol('Parent', parent, ...
                                               'Style', 'checkbox', ...
                                               'String', 'Calculate work (integral of power)', ...
                                               'Units', 'normalized', ...
                                               'Position', [0.05, 0.47, 0.9, 0.03], ...
                                               'BackgroundColor', colors.panel, ...
                                               'Value', 0, ...
    ...
    handles.calculate_power_checkbox = uicontrol('Parent', parent, ...
                                                'Style', 'checkbox', ...
                                                'String', 'Calculate power (torque × angular velocity)', ...
                                                'Units', 'normalized', ...
                                                'Position', [0.05, 0.44, 0.9, 0.03], ...
                                                'BackgroundColor', colors.panel, ...
                                                'Value', 1, ...
    ...
    uicontrol('Parent', parent, ...
              'Style', 'text', ...
              'String', 'Angular Impulse Calculations:', ...
              'Units', 'normalized', ...
              'Position', [0.05, 0.39, 0.9, 0.04], ...
              'FontWeight', 'bold', ...
              'HorizontalAlignment', 'left', ...
              'BackgroundColor', colors.panel);
    ...
    handles.calculate_joint_torque_impulse_checkbox = uicontrol('Parent', parent, ...
                                                                'Style', 'checkbox', ...
                                                                'String', 'Joint torque angular impulse (proximal/distal)', ...
                                                                'Units', 'normalized', ...
                                                                'Position', [0.05, 0.35, 0.9, 0.03], ...
                                                                'BackgroundColor', colors.panel, ...
                                                                'Value', 1, ...
    ...
    handles.calculate_applied_torque_impulse_checkbox = uicontrol('Parent', parent, ...
                                                                  'Style', 'checkbox', ...
                                                                  'String', 'Applied torque angular impulse (proximal/distal)', ...
                                                                  'Units', 'normalized', ...
                                                                  'Position', [0.05, 0.32, 0.9, 0.03], ...
                                                                  'BackgroundColor', colors.panel, ...
                                                                  'Value', 1, ...
                                                                  'TooltipString', 'Angular impulse from applied torques at proximal and distal ends');
    
    handles.calculate_force_moment_impulse_checkbox = uicontrol('Parent', parent, ...
                                                                'Style', 'checkbox', ...
                                                                'String', 'Force moment angular impulse (proximal/distal)', ...
                                                                'Units', 'normalized', ...
                                                                'Position', [0.05, 0.29, 0.9, 0.03], ...
                                                                'BackgroundColor', colors.panel, ...
                                                                'Value', 1, ...
                                                                'TooltipString', 'Angular impulse from force moments at proximal and distal ends');
    
    handles.calculate_total_angular_impulse_checkbox = uicontrol('Parent', parent, ...
                                                                 'Style', 'checkbox', ...
                                                                 'String', 'Total angular impulse per joint (proximal/distal/total)', ...
                                                                 'Units', 'normalized', ...
                                                                 'Position', [0.05, 0.26, 0.9, 0.03], ...
                                                                 'BackgroundColor', colors.panel, ...
                                                                 'Value', 1, ...
    ...
    uicontrol('Parent', parent, ...
              'Style', 'text', ...
              'String', 'Linear Impulse Calculations:', ...
              'Units', 'normalized', ...
              'Position', [0.05, 0.21, 0.9, 0.04], ...
              'FontWeight', 'bold', ...
              'HorizontalAlignment', 'left', ...
              'BackgroundColor', colors.panel);
    ...
    uicontrol('Parent', parent, ...
              'Style', 'text', ...
              'String', 'Joint-Specific Calculations:', ...
              'Units', 'normalized', ...
              'Position', [0.05, 0.12, 0.9, 0.04], ...
              'FontWeight', 'bold', ...
              'HorizontalAlignment', 'left', ...
              'BackgroundColor', colors.panel);
    
    handles.calculate_hip_calculations_checkbox = uicontrol('Parent', parent, ...
                                                            'Style', 'checkbox', ...
                                                            'String', 'Hip joint calculations', ...
                                                            'Units', 'normalized', ...
                                                            'Position', [0.05, 0.08, 0.9, 0.03], ...
                                                            'BackgroundColor', colors.panel, ...
                                                            'Value', 1, ...
                                                            'TooltipString', 'Enable calculations for hip joint');
    
    handles.calculate_knee_calculations_checkbox = uicontrol('Parent', parent, ...
                                                             'Style', 'checkbox', ...
                                                             'String', 'Knee joint calculations', ...
                                                             'Units', 'normalized', ...
                                                             'Position', [0.05, 0.05, 0.9, 0.03], ...
                                                             'BackgroundColor', colors.panel, ...
                                                             'Value', 1, ...
                                                             'TooltipString', 'Enable calculations for knee joint');
    
    handles.calculate_ankle_calculations_checkbox = uicontrol('Parent', parent, ...
                                                              'Style', 'checkbox', ...
                                                              'String', 'Ankle joint calculations', ...
                                                              'Units', 'normalized', ...
                                                              'Position', [0.05, 0.02, 0.9, 0.03], ...
                                                              'BackgroundColor', colors.panel, ...
                                                              'Value', 1, ...
                                                              'TooltipString', 'Enable calculations for ankle joint');
end
...
function startPostProcessing(~, ~)
    ...
    calculate_force_moment_impulse = get(handles.calculate_force_moment_impulse_checkbox, 'Value');
    ...
    calculate_hip_calculations = get(handles.calculate_hip_calculations_checkbox, 'Value');
    calculate_knee_calculations = get(handles.calculate_knee_calculations_checkbox, 'Value');
    calculate_ankle_calculations = get(handles.calculate_ankle_calculations_checkbox, 'Value');
    ...
    processing_data.calculate_force_moment_impulse = calculate_force_moment_impulse;
    ...
    processing_data.calculate_hip_calculations = calculate_hip_calculations;
    processing_data.calculate_knee_calculations = calculate_knee_calculations;
    processing_data.calculate_ankle_calculations = calculate_ankle_calculations;
